...
/*! flagged exports */
/*! export __esModule [provided] [no usage info] [missing usage info prevents renaming] */
/*! export beforeEachHook [provided] [no usage info] [missing usage info prevents renaming] */
...
"use strict";
eval("\r\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\r\nexports.transitionTo = exports.beforeEachHook = exports.callHook = void 0;\r\nvar utils_1 = __webpack_require__(/*! ../helpers/utils */ \"./src/helpers/utils.ts\");\r\nfunction callHook(hook, to, from) {\r\n    return new Promise(function (resolve) {\r\n        if (hook != null && hook instanceof Function) {\r\n            hook(to, from, resolve);\r\n        }\r\n        else {\r\n            resolve();\r\n        }\r\n    });\r\n}\r\nexports.callHook = callHook;\r\nvar hookList = [\r\n    function (router, to, from, toRoute) { return callHook(router.lifeCycle.routerBeforeHooks[0], to, from); },\r\n    function (router, to, from, toRoute) {\r\n        var page = window.getCurrentPages()[0];\r\n        if (page != null) {\r\n            return callHook(page.$options.beforeRouteLeave[0], to, from);\r\n        }\r\n        return callHook(undefined, to, from);\r\n    },\r\n    function (router, to, from, toRoute) { return callHook(router.lifeCycle.beforeHooks[0], to, from); },\r\n    function (router, to, from, toRoute) { return callHook(toRoute.beforeEnter, to, from); },\r\n    function (router, to, from, toRoute) { return callHook(router.lifeCycle.afterHooks[0], to, from); },\r\n    function (router, to, from, toRoute) { return callHook(router.lifeCycle.routerAfterHooks[0], to, from); }\r\n];\r\nfunction beforeEachHook(to, from, next, router, userGuard) {\r\n    transitionTo(router, to, from, function () {\r\n    });\r\n}\r\nexports.beforeEachHook = beforeEachHook;\r\nfunction transitionTo(router, to, from, hookCB) {\r\n    var toRoute = utils_1.routesForMapRoute(router.routesMap, to.path);\r\n    function loopCallHook(hooks, index, next) {\r\n        if (hooks.length - 1 < index) {\r\n            return next();\r\n        }\r\n        var hook = hookList[index];\r\n        hook(router, to, from, toRoute).then(function (to) {\r\n            console.log(to);\r\n            if (to === false) {\r\n            }\r\n            else if (typeof to === 'string' || typeof to === 'object') {\r\n                router.push(to);\r\n            }\r\n            index++;\r\n            loopCallHook(hooks, index, next);\r\n        });\r\n    }\r\n    loopCallHook(hookList, 0, function () {\r\n        console.log('生命周期执行完毕');\r\n    });\r\n    // for (let i = 0; i < hookList.length; i++) {\r\n    //     const hook = hookList[i];\r\n    //     hook(router, to, from, toRoute);\r\n    // }\r\n}\r\nexports.transitionTo = transitionTo;\r\n\n\n//# sourceURL=webpack://Router/./src/public/hooks.ts?");
