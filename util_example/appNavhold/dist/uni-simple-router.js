...
/*! flagged exports */
/*! export __esModule [provided] [no usage info] [missing usage info prevents renaming] */
/*! export queryPageToMap [provided] [no usage info] [missing usage info prevents renaming] */
/*! other exports [not provided] [no usage info] */
/*! runtime requirements: __webpack_exports__, __webpack_require__ */
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {

"use strict";
eval("\r\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\r\nexports.queryPageToMap = void 0;\r\nvar utils_1 = __webpack_require__(/*! ../helpers/utils */ \"./src/helpers/utils.ts\");\r\nvar hooks_1 = __webpack_require__(/*! ./hooks */ \"./src/public/hooks.ts\");\r\nvar Regexp = __webpack_require__(/*! path-to-regexp */ \"./node_modules/path-to-regexp/index.js\");\r\nfunction queryPageToMap(toPath, router) {\r\n    var path = toPath;\r\n    if (utils_1.getDataType(toPath) === '[object Object]') {\r\n        var objNavRule = toPath;\r\n        if (objNavRule.path != null) {\r\n            path = objNavRule.path;\r\n        }\r\n        else if (objNavRule.name != null) {\r\n            var route = router.routesMap.nameMap[objNavRule.name];\r\n            if (route == null) {\r\n                hooks_1.ERRORHOOK[0]({ type: 2, msg: \"\\u547D\\u540D\\u8DEF\\u7531\\u4E3A\\uFF1A\" + objNavRule.name + \" \\u7684\\u8DEF\\u7531\\uFF0C\\u65E0\\u6CD5\\u5728\\u8DEF\\u7531\\u8868\\u4E2D\\u627E\\u5230\\uFF01\", toPath: toPath }, router);\r\n            }\r\n            else {\r\n                path = utils_1.getRoutePath(route).finallyPath;\r\n            }\r\n        }\r\n        else {\r\n            hooks_1.ERRORHOOK[0]({ type: 2, msg: toPath + \" \\u89E3\\u6790\\u5931\\u8D25\\uFF0C\\u8BF7\\u68C0\\u6D4B\\u5F53\\u524D\\u8DEF\\u7531\\u8868\\u4E0B\\u662F\\u5426\\u6709\\u5305\\u542B\\u3002\", toPath: toPath }, router);\r\n        }\r\n    }\r\n    console.log(path);\r\n}\r\nexports.queryPageToMap = queryPageToMap;\r\n\n\n//# sourceURL=webpack://Router/./src/public/page.ts?");
