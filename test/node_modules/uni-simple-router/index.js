...
class Router {
	constructor(arg) {
		...
		lifeMothods.registerHook(this.lifeCycle.routerAfterHooks, async function (res) {
			console.log(6666)
			compile.H5(() => {
	...
	getQuery(Vim) {
		...
		return resolveRule(this, routeInfo.route, routeInfo.query);
	}
	beforeEach(fn) {
...
export const RouterMount = function (app) {
	switch (appPlatform(true)) {
		...
		case 'APPLETS':
			...
			break
		default:
			err(`居然还有其他的运行环境？？？？？一脸懵逼 \r\n\n 请联系作者 或加QQ群:769241495`);
			break
	}
}